...
#  Description: This code provides a simple method for representing a visual scene as it may be seen by an animal
#               with less acute vision. For more information, please refer to, and when using please cite,
#               the original publication: "XXXXXXXXXXXXXX"
#  Depends: R (>= 3.0.0), imager (>= 2.10.0), fftwtools (>= 2.15.2),
#    pracma (>= 2.11.1), plotrix (>= 3.2.3), tools (>= 3.3.1), grid (>=1.8.0)
#  License: GPL (>= 2)
#  NeedsCompilation: no
#  Packaged: 2017-02-10 20:47:13 UTC; Eleanor
#  Repository: n/a
#  Date/Publication: 2017-MM-DD
#  Change log:
...
#    source("AcuityView.R")
#    Example command:
# AcuityView(photo = NULL, distance = 2, realWidth = 2, eyeResolutionX = 0.2, eyeResolutionY = NULL, plot = T, output="Test.jpeg")

# REQUIREMENTS/ASSUMPTIONS:
#  Image must be in 3-channel format, either PNG, JPEG or BMP. Note: some PNG files have an alpha channel that makes them
#         4-channel images; this will not work with the code. The image must be 3-channel.
#   Image must be square with each side a power of 2 pixels
#   Example: 512x512, 1024 x 1024, 2048 x 2048 pixels
#  Output image can be in "png", "jpeg", or "bmp" format.
...
# Because of the way fourier transforms are calculated in R,
# you need to create a custom function which will rearrange
# the output of the fft by moving the zero frequency component
